...
//protocol ImagesDownloaderDelegate {
//    func imageDownloaded(didDownloadImage image: String)
//    func imageDownloadFailed()
//    func imageDownloadPaused()
//    func imageDownloadResumed()
//}
//
//class NetworkService {
//    var delegate: ImagesDownloaderDelegate?
//
//    func fetchImageFromBE() {
//        //call api and handle all cases
//
//        //if success
//        delegate?.imageDownloaded(didDownloadImage: "img from BE")
//
//        //if failed
//        delegate?.imageDownloaderDidFail()
//
//        //if pause
//        delegate?.imageDownloaderDidPause()
//
//        //if resume
//        delegate?.imageDownloaderDidResume()
//    }
//}
//
//class ImagePickerViewController {
...
//    }
//
//    //for example button was clicked and this func was called
//    func buttonPressed() {
//        networkService.fetchImageFromBE()
//    }
//}
//
//extension ImagePickerViewController: ImagesDownloaderDelegate {
//    func imageDownloaded(didDownloadImage image: String) {
//        //proccess working with img
//        print("\(image) was downloaded")
//    }
//
//    func imageDownloaderDidFail() {
//        //show error alert
//        print("failed")
//    }
//
//    func imageDownloaderDidPause() {
//        //show that it's paused
//        print("paused")
//    }
//
//    func imageDownloaderDidResume() {
//        //show that it's resumed
//        print("resumed")
//    }
//}
